...
export class EndWorkDto {
  @ApiPropertyOptional({ description: 'GPS latitude at work end', example: 6.5244 })
  @IsOptional()
  @IsNumber()
  @Min(-90)
  @Max(90)
  ...
  @ApiPropertyOptional({ description: 'GPS longitude at work end', example: 3.3792 })
  @IsOptional()
  @IsNumber()
  @Min(-180)
  @Max(180)
  ...
  @ApiPropertyOptional({ description: 'Optional notes for ending the work session' })
  @IsOptional()
  @IsString()
  notes?: string;
}
