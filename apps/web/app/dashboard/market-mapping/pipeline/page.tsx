...
import { ArrowLeft, Navigation, LayoutGrid, Table, MapPin, Clock, CheckCircle2 } from 'lucide-react';
...
export default function PipelinePage() {
  const { visits, setSelectedVisit, selectedVisit, saveCapture } = useMarketMapping();
          ...
          <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden">
            {filteredVisits.length > 0 ? (
              ...
              <div className="p-12 text-center">
                ...
                <p className="text-xs text-slate-400 mt-1">Add businesses in Execute Visits to see them here</p>
              </div>
            )}
          </div>
        )}
